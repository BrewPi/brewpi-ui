...
view.steps = [
  ...
  require('./steps/13_push_wort_out_of_coil.json'),
  require('./steps/14_boil.json'),
  require('./steps/15_whirlpool.json'),
  require('./steps/16_prepare_transfer.json'),
  require('./steps/17_cool_and_transfer.json'),
